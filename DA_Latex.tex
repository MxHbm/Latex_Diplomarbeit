...
\input{src_files/abbreviations.tex}
\input{src_files/symbols.tex}
...
\input{src_files/0_introduction.tex}
\input{src_files/1_literature_review.tex}
\input{src_files/3_binary_classifier.tex}
\input{src_files/4_algorithm.tex}
\input{src_files/5_computational_study.tex}
\input{src_files/6_generalization.tex}
\input{src_files/7_conclusion.tex}


%####################### Appendix #########################
\include{src_files/appendix}
\clearpage
