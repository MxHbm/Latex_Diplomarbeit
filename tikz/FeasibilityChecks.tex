...
\begin{figure}[h]
    ...
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        \begin{tikzpicture}[node distance=11mm and 16mm,scale=0.85, transform shape]
            \begin{scope}
                % Nodes
                \node[dot] (start) {};
    ...
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        \begin{tikzpicture}[node distance=7mm and 16mm,scale=0.85, transform shape]
            \begin{scope}
                % Nodes
                \node[dot] (start) {};
                \node[decisionY, below=of start] (d1) {Classifier\\Check};
    ...
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        \begin{tikzpicture}[node distance=11mm and 2mm,scale=0.85, transform shape]
            \begin{scope}
                % Nodes
                \node[dot] (start) {};
                \node[decision, below=of start] (d1) {SpeedUp\\Neighbor-\\hood?};
                \node[block,  below left=of d1] (Filter){Use Filter \\ Variant};
                \node[block,  below right=of d1] (SpeedUp){Use SpeedUp \\ Variant};
                ...
                \node[dot] (end) at ($(mid)+(0,-11mm)$) {}; % adjust 8mm as you like
                % Arrows
                \draw[line] (start) -- (d1);
                \draw[line] (d1) -| node[pos=0.3,above]{\textbf{False}}(Filter);
                \draw[line] (d1) -| node[pos=0.3,above]{\textbf{True}}(SpeedUp);
