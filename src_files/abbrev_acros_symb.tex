...
\newacronym[description={Area Under Receiver Operating Curve}]{AUROC}{AUROC}{area under receiver operating curve}
\newacronym[description={Forward Sequential Feature Selector}]{FSFS}{FSFS}{forward sequential feature selector}
...
\newacronym[description = {Loading Flag}, plural = LoadFls]{LoadFl}{LoadFl}{loading flag}
\newacronym[description = {Loading Status}]{LoadSt}{LoadSt}{loading status}
