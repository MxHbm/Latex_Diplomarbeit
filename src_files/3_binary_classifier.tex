...
The random routes are created with the Algorithm~\ref{alg:rand_routes_generation}, and four parameters are introduced to
...
\begin{itemize}
    \item 4 Input Parameters
          \begin{itemize}
              ...
              \item  Lower threshold $\delta$: Float determining the range [$\delta$,1] to draw relative volume and weight capacity for one route
