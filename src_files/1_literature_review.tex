...
\begin{table}[ht]
	...
	\begin{tabular}{@{}
			...
			P{0.11\textwidth} % Problem
			P{0.18\textwidth} % Routing Algorithm
		...
		\midrule
		16          & \citeyear{kucuk_constraint_2022}       & \citeauthor{kucuk_constraint_2022}       & 3L--VRPTW        & CP-Solver                          & Evolutionary Algorithm                        & Full rotation                   \\
