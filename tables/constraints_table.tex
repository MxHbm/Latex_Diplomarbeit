...
\begin{table}[ht]
    ...
    \begin{tabular}{@{}L{1.8cm}L{3cm}C{1.6cm}C{1.6cm}C{1.6cm}C{1.6cm}C{1.6cm}@{}}
        ...
        \bottomrule
    \end{tabular}
    \caption[Overview of CLP constraints in selected 3L--CVRP datasets.]{Overview of CLP constraints in selected 3L--CVRP datasets. A bullet ($\bullet$) indicates that the constraint is considered.}
